...
db.estudiante.hasMany(db.prestamo, { foreignKey: "estudiante_id" });
db.prestamo.belongsTo(db.estudiante, { foreignKey: "id_estudiante" });

db.libro.hasMany(db.prestamo, { foreignKey: "libro_id" });
db.prestamo.belongsTo(db.libro, { foreignKey: "id_libro" });
